...
config
  .setAliasAdUnits('default', [
    ...
    { name: 'lb2', templateName: 'LB', path: 'CEN-SL' },
    { name: 'rail1', templateName: 'CONTENT', path: 'CEN-MR' },
    { name: 'rail2', templateName: 'CONTENT', path: 'CEN-MR' },
    { name: 'load-more', templateName: 'CONTENT', path: 'CEN-MR' },
    { name: 'billboard', templateName: 'BILLBOARD', path: 'CEN-SL' },
