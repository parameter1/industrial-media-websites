...
config
  .setAliasAdUnits('default', [
    ...
    { name: 'lb2', templateName: 'LB', path: 'IEN-SL' },
    { name: 'rail1', templateName: 'CONTENT', path: 'IEN-MR' },
    { name: 'rail2', templateName: 'CONTENT', path: 'IEN-MR' },
    { name: 'load-more', templateName: 'CONTENT', path: 'IEN-MR' },
    { name: 'billboard', templateName: 'BILLBOARD', path: 'IEN-SL' },
